<template>
  <main id="home">
    ...
    <header>
        <div class="logo">
        <img src="logo.png" alt="Logomarca da loja lukesbrownie" title="Logomarca Lukesbrownie" width="150" height="150">
        </div>
    </header>
        ...
        <div id="carouselExampleControls" class="container clearfix carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="imagens/produtos/Brownie P1.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="imagens/produtos/Docinhos P3.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="imagens/produtos/Fatia de Torta Bem Casado P2.jpg" class="d-block w-100" alt="...">
              </div>
            </div>
    ...
    <footer>
        ...
        <p>Feito por Carolina</p>
         <img src="icone.png">
          <div>
             <img src="imagens/rede_social/facebook.png " class="img-fluid p5 rounded-circle">
          </div>
         <div>
            <img src="imagens/rede_social/instagram.png" class="img-fluid p5 rounded-circle">
        </div>
        <div>
            <img src="imagens/rede_social/twitter.png" class="img-fluid p5 rounded-circle">
        </div>
    </footer>
    <!-- 
